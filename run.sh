...
cargo run --release --bin dry_run -- -m /home/kiki/Documents/HERODOTUS/MOST/hdp-modules/target/dev/custom_module_multi_cairovm_starknet_get_storage.compiled_contract_class.json --print_output --inputs /home/kiki/Documents/HERODOTUS/MOST/hdp-modules/tests/example_inputs_starknet.json
